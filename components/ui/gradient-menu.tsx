...
// biblioteca de ícones do resto do projeto — em vez de react-icons, os
// itens vêm por prop (navegação real, não uma lista fixa) e cada item é um
// link de verdade (não só decorativo).
